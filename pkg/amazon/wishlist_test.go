...
func TestItems(t *testing.T) {
	...
	require.NoError(t, err)
	expectedDateAdded := time.Date(2019, 7, 10, 0, 0, 0, 0, time.UTC)
	require.Equal(t, &expectedDateAdded, dateAdded)
